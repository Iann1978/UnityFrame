...
function PanelMain:Init()
    ...
    self.subPropertyBox = self.base:GetSubPanel("PropertyBox");
    print(self.txUsername)
    self.subPropertyBox:Init();
    --self.subPropertyBox:Refresh();
...
function PanelMain:OnButtonTeamBoxClick()
    Debugger.Log("PanelMain:OnButtonTeamBoxClick")
