...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(Assets.Script.Frame.PanelManager.FuncInstanceUiBase), Assets_Script_Frame_PanelManager_FuncInstanceUiBase);
		dict.Add(typeof(System.Predicate<HeroInfo>), System_Predicate_HeroInfo);
		dict.Add(typeof(System.Action<HeroInfo>), System_Action_HeroInfo);
		dict.Add(typeof(System.Comparison<HeroInfo>), System_Comparison_HeroInfo);
	}
	...
	class Assets_Script_Frame_PanelManager_FuncInstanceUiBase_Event : LuaDelegate
	{
		public Assets_Script_Frame_PanelManager_FuncInstanceUiBase_Event(LuaFunction func) : base(func) { }
		public Assets_Script_Frame_PanelManager_FuncInstanceUiBase_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public Assets.Script.Frame.PanelBase CallWithSelf(Assets.Script.Frame.PanelBase param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public static Delegate Assets_Script_Frame_PanelManager_FuncInstanceUiBase(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Assets.Script.Frame.PanelManager.FuncInstanceUiBase fn = delegate(Assets.Script.Frame.PanelBase param0) { return null; };
			return fn;
		}

		if(!flag)
		{
			Assets_Script_Frame_PanelManager_FuncInstanceUiBase_Event target = new Assets_Script_Frame_PanelManager_FuncInstanceUiBase_Event(func);
			Assets.Script.Frame.PanelManager.FuncInstanceUiBase d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Assets_Script_Frame_PanelManager_FuncInstanceUiBase_Event target = new Assets_Script_Frame_PanelManager_FuncInstanceUiBase_Event(func, self);
			Assets.Script.Frame.PanelManager.FuncInstanceUiBase d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class System_Predicate_HeroInfo_Event : LuaDelegate
	{
		public System_Predicate_HeroInfo_Event(LuaFunction func) : base(func) { }
		public System_Predicate_HeroInfo_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public bool Call(HeroInfo param0)
		{
			func.BeginPCall();
		...
		public bool CallWithSelf(HeroInfo param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public static Delegate System_Predicate_HeroInfo(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Predicate<HeroInfo> fn = delegate(HeroInfo param0) { return false; };
			return fn;
		}

		if(!flag)
		{
			System_Predicate_HeroInfo_Event target = new System_Predicate_HeroInfo_Event(func);
			System.Predicate<HeroInfo> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Predicate_HeroInfo_Event target = new System_Predicate_HeroInfo_Event(func, self);
			System.Predicate<HeroInfo> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class System_Action_HeroInfo_Event : LuaDelegate
	{
		public System_Action_HeroInfo_Event(LuaFunction func) : base(func) { }
		public System_Action_HeroInfo_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public void CallWithSelf(HeroInfo param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public static Delegate System_Action_HeroInfo(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<HeroInfo> fn = delegate(HeroInfo param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_HeroInfo_Event target = new System_Action_HeroInfo_Event(func);
			System.Action<HeroInfo> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_HeroInfo_Event target = new System_Action_HeroInfo_Event(func, self);
			System.Action<HeroInfo> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class System_Comparison_HeroInfo_Event : LuaDelegate
	{
		public System_Comparison_HeroInfo_Event(LuaFunction func) : base(func) { }
		public System_Comparison_HeroInfo_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public int Call(HeroInfo param0, HeroInfo param1)
		{
			func.BeginPCall();
			func.PushObject(param0);
		...
		public int CallWithSelf(HeroInfo param0, HeroInfo param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public static Delegate System_Comparison_HeroInfo(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Comparison<HeroInfo> fn = delegate(HeroInfo param0, HeroInfo param1) { return 0; };
			return fn;
		}

		if(!flag)
		{
			System_Comparison_HeroInfo_Event target = new System_Comparison_HeroInfo_Event(func);
			System.Comparison<HeroInfo> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Comparison_HeroInfo_Event target = new System_Comparison_HeroInfo_Event(func, self);
			System.Comparison<HeroInfo> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
